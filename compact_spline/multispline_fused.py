...
def multispline_fused(feats: torch.Tensor,
                ...
                primes: torch.Tensor, offsets: torch.Tensor) -> torch.Tensor:
    return torch.ops.compact_spline.multispline_fused(
        feats, edge_index, scatter_index, pseudo, kernel_size, is_open_spline, size_scatter_out, basis, weight_index, log2_hashmap_size, primes, offsets)